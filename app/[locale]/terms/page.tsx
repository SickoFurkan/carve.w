...
export default function TermsPage() {
  return (
    <main className="min-h-screen bg-[#ececf1] py-20 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm p-8 md:p-12">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">5.2 License to Carve</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">5.3 Public Content</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">5.4 Content Standards</h3>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">7. Health and Fitness Disclaimer</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3 mt-6">9.2 By Carve</h3>
            <p className="text-gray-700 mb-4">
