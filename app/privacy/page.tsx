    ...
    <main className="min-h-screen bg-[#ececf1] py-20 px-4">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-sm p-8 md:p-12">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Your Privacy Rights (GDPR & CCPA)</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">13. Third-Party Services</h2>
            <p className="text-gray-700 mb-4">Our Service uses the following third-party providers:</p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
